...
app.controller("dataImagesWork", function ($scope) {
    $scope.images_work = [
          ...
          { num: 3, category: 'design', src: "images/design2.png", description: 'Complete Web Design and Development of DeliciousScrapShop ', url_details: "http://deliciousscraps.com" }
